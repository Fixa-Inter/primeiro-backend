...
public class Pagamento {
    ...
    private Timestamp dataPagamento;     // coluna: data_pagamento
    ...
    public Pagamento(Integer id, Float valor, Timestamp dataPagamento, Boolean foiRealizado, Integer fkContrato, Integer fkMetodoPagamento) {
        this.id = id;
        this.valor = valor;
